...
/**
  ...
  @retval SUCCESS   The image fix up is processed successfully.
**/
RETURN_STATUS
ProcessRelocation32 (
  IN  Elf32_Rela  *Rela,
...
/**
  ...
  @retval SUCCESS      The relocation succeeds.
  @retval UNSUPPORTED  The image doesn't contain a dynamic section.
**/
RETURN_STATUS
...
/**
  ...
  @retval UNSUPPORTED         Relocation is not supported.
  @retval SUCCESS             ELF image was relocated successfully.
**/
RETURN_STATUS
